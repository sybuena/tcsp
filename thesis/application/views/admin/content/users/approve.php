...
<div class="box">
	<div class="box-header"><span class="title">Members</span></div>
                    	...
                    	<tbody>
							<?php foreach((array)$memberList as $key => $value): ?>
                                <tr>
                                  ...
                                  <td class="center">
                                  	<a class="btn btn-mini btn-primary" onClick="javascript:chatWith('<?php echo $value['username']; ?>');">Send Message</a>
