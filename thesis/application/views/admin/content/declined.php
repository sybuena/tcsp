	...
	<div class="row-fluid">
		<div class="area-top clearfix">
        	<div class="pull-left header">
          		<h3 class="title"><i class="icon-archive"></i>Archived Members</h3>
          		<h5>View all archived member</h5>
        	</div>
      </div>
    </div>
</div>
...
<div class="container-fluid padded">
	<div class="row-fluid">
		<div id="breadcrumbs">
			...
			<div class="breadcrumb-button">
          		<span class="breadcrumb-label"><i class="icon-share-sign"></i> Archived</span>
          		<span class="breadcrumb-arrow"><span></span></span>
        	</div>
      	</div>
    </div>
