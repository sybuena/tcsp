...
<div id="content">
     ...
     <div class="block features">
          ...
          <ul class="thumbnails">
            <li class="span3">
              ...
              <h3 class="title"><a href="#">Oct<span class="de-em"> 2000</span></a></h3>
            ...
            <li class="span3">
              ...
              <h3 class="title"><a href="#">Feb <span class="de-em">2001</span></a></h3>
              <p>First Chinese New Year of the Taiwanese Chamber of the South Phils</p>
            </li>
            
            <li class="span3">
              <a href=""><img src="/assets/images/e3.png" alt="Feature 1"></a>
              <h3 class="title"><a href="#">Sept <span class="de-em">2001</span></a></h3>
              <p>Mooncake Festival</p>
            </li>
            
            <li class="span3">
              <a href=""><img src="/assets/images/e4.png" alt="Feature 1"></a>
              <h3 class="title"><a href="#">Feb <span class="de-em">2002</span></a></h3>
              <p>TAIWANESE CHAMBER FIRST ANNUAL ANNIVERSARY</p>
            </li>             
          </ul>
        </div>
          ...
          <div class="row">
            <div class="span4">
              <blockquote>
                ...
                <small> -- Wen Ju Chen <span class="spacer">/</span> <a href="#">@wenjuchen</a></small>
              </blockquote>
            </div>
            
            <div class="span4">
              <blockquote>
                <p>"Feel free to visit our website and register now to become part of our organization"</p>
                <small>  Ken Huang <span class="spacer">/</span> <a href="#">The President</a></small>
              </blockquote>
            </div>
  ...
  <ul class="thumbnails block customers"> 
	  ...
	  <span class="inner-wrapper">
        ...
        <span class="title" style="text-align:center">Tong Hsing Electronic Industries</span>
	  </span>
	</a>
      </li> 
        <li class="span4 type-media" data-quicksand-id="id-0" data-quicksand-tid="type-media">
