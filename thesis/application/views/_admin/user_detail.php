  ...
  <div class="span12">
    ...
    <div class="box">
      ...
      <div class="box-content">
        ...
        <form class="fill-up validatable" method="post" action="<?php echo '/admin/users/editUser/'.$row['ID']; ?>">
		<div class="row-fluid">
            <div class="span6">
			<ul class="padded separate-sections">
                ...
                <li class="input">
                  ...
                  <input type="text" class="validate[required]" placeholder="Email" name="surname" value="<?php echo $row['surname']; ?>"/>
                </li>
                ...
                <li class="input">
                  ...
                  <input type="text" class="validate[required]" placeholder="Username"  name="username" value="<?php echo $row['username']; ?>"/>
                </li>

				
				<li class="input">
                	<label><h5>City :</h5></label>
                  <input type="text" class="validate[required]" placeholder="Password"  name="city" value="<?php echo $row['city']; ?>"/>
                </li>
                	<li class="input">
                	<label><h5>Address :</h5></label>
                  <textarea placeholder="Address" class="validate[required]" rows="6" name="address"><?php echo $row['address']; ?></textarea>
                </li>
                <li>
                	
                	<label for="ienabled"><h5>Enable :</h5></label>
                	<?php if($row['enable']): ?>
           		 		<input type="checkbox" class="iButton-icons" checked="checked" id="ienabled" name="enable"/>
                    <?php else: ?>
           		 		<input type="checkbox" class="iButton-icons" id="ienabled" name="enable"/>
					<?php endif;?>
            ...
            <div class="span6">
              ...
              <ul class="padded separate-sections">
                ...
                <li class="input">
                  ...
                  <textarea placeholder="User note" name="note" class="validate[required]" rows="6"><?php echo $row['note']; ?></textarea>
                </li>
                <li>
            		<h4 class="title">
            		Payment Information
