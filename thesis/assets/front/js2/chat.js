...
function chatHeartbeat(){
	...
	jQuery.ajax({
	  url: "http://tcsp.org/application/views/chat/chat.php?action=chatheartbeat",
	  cache: false,
	  dataType: "json",
...
function closeChatBox(chatboxtitle) {
	...
	jQuery.post("http://tcsp.org/application/views/chat/chat.php?action=closechat", { chatbox: chatboxtitle} , function(data){	
	});
...
function checkChatBoxInputKey(event,chatboxtextarea,chatboxtitle) {
	...
	if(event.keyCode == 13 && event.shiftKey == 0)  {
		...
		if (message != '') {
			jQuery.post("http://tcsp.org/application/views/chat/chat.php?action=sendchat", {to: chatboxtitle, message: message} , function(data){
...
function startChatSession(){  
	jQuery.ajax({
	  url: "http://tcsp.org/application/views/chat/chat.php?action=startchatsession",
	  cache: false,
	  dataType: "json",
	  success: function(data) {
